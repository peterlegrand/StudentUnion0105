...
namespace StudentUnion0105.Migrations
{
    ...
    [Migration("20191003071118_flowstuff10")]
    partial class flowstuff10
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "0526109d-c1e0-4d80-abed-b10bcf136a01",
                            ConcurrencyStamp = "a8ff3fde-d9e9-4385-853f-24d685d0eb68",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "ee097ca0-653f-4245-9b95-fc4c1d45eac3",
                            ConcurrencyStamp = "0121750b-6edc-4dd8-8521-6d23fded7c7f",
                            Name = "Super admin",
            ...
            modelBuilder.Entity("StudentUnion0105.Models.SuProcessTemplateFlowModel", b =>
                {
                    ...
                    b.HasIndex("ProcessTemplateFromStepId");

                    b.HasIndex("ProcessTemplateId");

                    b.HasIndex("ProcessTemplateToStepId");
            ...
            modelBuilder.Entity("StudentUnion0105.Models.SuProcessTemplateFlowModel", b =>
                {
                    b.HasOne("StudentUnion0105.Models.SuProcessTemplateStepModel", "ProcessTemplateFromStep")
                        .WithMany()
                        .HasForeignKey("ProcessTemplateFromStepId");
                    ...
                    b.HasOne("StudentUnion0105.Models.SuProcessTemplateStepModel", "ProcessTemplateToStep")
                        .WithMany()
                        .HasForeignKey("ProcessTemplateToStepId");
                });
