...
{
    public class SuFrontPageSectionModel
    {
        [Key]
        ...
        [ForeignKey("PId")]
        public virtual SuFrontPageModel FrontPage { get; set; }
        public virtual ICollection<SuFrontContentModel> FrontContent { get; set; }
    }
}
