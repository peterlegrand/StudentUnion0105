...
namespace StudentUnion0105.Controllers
{
    public class PageSectionController : Controller
    {
        ...
        public async Task<IActionResult> Edit(PageSectionAndStatusViewModel UpdatedPageSection)
        {
                ...
                //                    var oldValue = _pageSection.GetPageSection(UpdatedPageSection.SuObject.ObjectId).Sequence;
                // var AllSections = _pageSection.GetAllPageSections();
                ////
                //List<IdAndSequence> AllSections = (from c in _pageSection.GetAllPageSections()
                //                                      where c.PageId == UpdatedPageSection.SuObject.Id
                //                                      && c.Sequence >= UpdatedPageSection.SuObject.Sequence
