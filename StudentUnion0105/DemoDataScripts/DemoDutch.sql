...
VALUES(1, 39, 'A','A: Tropish klimaat','A','A','A: Tropish klimaat' 
...
, ClassificationValueTopicName 
, CreatorId, ModifierId, CreatedDate, ModifiedDate)  
VALUES(2, 39, 'B','B: Droog (woestijn) klimaat','B','B','B: Droog (woestijn) klimaat' 
...
, ClassificationValueTopicName 
, CreatorId, ModifierId, CreatedDate, ModifiedDate)  
VALUES(6, 39, 'Af','Af: Tropisch regenwoud klimaat','Af','Af','Af: Tropisch regenwoud klimaat' 
...
, ClassificationValueTopicName 
, CreatorId, ModifierId, CreatedDate, ModifiedDate)  
VALUES(7, 39, 'Am','Am: Tropisch moesson klimaat','Am','Am','Am: Tropisch moesson klimaat' 
...
, ClassificationValueTopicName 
, CreatorId, ModifierId, CreatedDate, ModifiedDate)  
VALUES(8, 39, 'Aw/As','Aw/As: Tropisch savanne klimaat','Aw/As','Aw/As','Aw/As: Tropisch savanne klimaat' 
...
, ClassificationValueTopicName 
, CreatorId, ModifierId, CreatedDate, ModifiedDate)  
VALUES(9, 39, 'Aw','Aw: Tropisch savanne klimaat met geen seizoen of droge winter kenmerken','Aw','Aw','Aw: Tropisch savanne klimaat met geen seizoen of droge winter kenmerken' 
...
, ClassificationValueTopicName 
, CreatorId, ModifierId, CreatedDate, ModifiedDate)  
VALUES(10, 39, 'As','As: Tropisch savanne klimaat met droge zomer kenmerk','As','As','As: Tropisch savanne klimaat met droge zomer kenmerk' 
...
, ClassificationValueTopicName 
, CreatorId, ModifierId, CreatedDate, ModifiedDate)  
VALUES(13, 39, 'Csa','Csa: Mediterrane hete zomerklimaat','Csa','Csa','Csa: Mediterrane hete zomerklimaat' 
...
, ClassificationValueTopicName 
, CreatorId, ModifierId, CreatedDate, ModifiedDate)  
VALUES(14, 39, 'Csb','Csb: Mediterraan warm / koel zomerklimaat','Csb','Csb','Csb: Mediterraan warm / koel zomerklimaat' 
...
, ClassificationValueTopicName 
, CreatorId, ModifierId, CreatedDate, ModifiedDate)  
VALUES(15, 39, 'Csc','Csc: Mediterraan koud zomerklimaat','Csc','Csc','Csc: Mediterraan koud zomerklimaat' 
...
, ClassificationValueTopicName 
, CreatorId, ModifierId, CreatedDate, ModifiedDate)  
VALUES(16, 39, 'Cfa','Cfa: Vochtige subtropische klimaat','Cfa','Cfa','Cfa: Vochtige subtropische klimaat' 
...
, ClassificationValueTopicName 
, CreatorId, ModifierId, CreatedDate, ModifiedDate)  
VALUES(18, 39, 'Cfc','Cfc: Subpolair oceaanklimaat','Cfc','Cfc','Cfc: Subpolair oceaanklimaat' 
...
, ClassificationValueTopicName 
, CreatorId, ModifierId, CreatedDate, ModifiedDate)  
VALUES(19, 39, 'Cwa','Cwa: Droge winter vochtig subtropisch klimaat','Cwa','Cwa','Cwa: Droge winter vochtig subtropisch klimaat' 
...
, ClassificationValueTopicName 
, CreatorId, ModifierId, CreatedDate, ModifiedDate)  
VALUES(20, 39, 'Cwb','Cwb: Droog-winter subtropisch hooglandklimaat','Cwb','Cwb','Cwb: Droog-winter subtropisch hooglandklimaat' 
...
, ClassificationValueTopicName 
, CreatorId, ModifierId, CreatedDate, ModifiedDate)  
VALUES(21, 39, 'Cwc','Cwc: Droog-winter subpolair oceaanklimaat','Cwc','Cwc','Cwc: Droog-winter subpolair oceaanklimaat' 
...
, ClassificationValueTopicName 
, CreatorId, ModifierId, CreatedDate, ModifiedDate)  
VALUES(22, 39, 'Dfa/Dwa/Dsa','Dfa/Dwa/Dsa: Hete zomer continentale klimaten','Dfa/Dwa/Dsa','Dfa/Dwa/Dsa','Dfa/Dwa/Dsa: Hete zomer continentale klimaten' 
...
, ClassificationValueTopicName 
, CreatorId, ModifierId, CreatedDate, ModifiedDate)  
VALUES(23, 39, 'Dfb/Dwb/Dsb','Dfb/Dwb/Dsb: Warme zomer continentale of hemiboreale klimaat','Dfb/Dwb/Dsb','Dfb/Dwb/Dsb','Dfb/Dwb/Dsb: Warme zomer continentale of hemiboreale klimaat' 
...
, ClassificationValueTopicName 
, CreatorId, ModifierId, CreatedDate, ModifiedDate)  
VALUES(24, 39, 'Dfc/Dwc/Dsc','Dfc/Dwc/Dsc: Subarctische of boreale klimaat','Dfc/Dwc/Dsc','Dfc/Dwc/Dsc','Dfc/Dwc/Dsc: Subarctische of boreale klimaat' 
...
, ClassificationValueTopicName 
, CreatorId, ModifierId, CreatedDate, ModifiedDate)  
VALUES(25, 39, 'Dfd/Dwd/Dsd','Dfd/Dwd/Dsd: Subarctische of boreale klimaat met strenge winters','Dfd/Dwd/Dsd','Dfd/Dwd/Dsd','Dfd/Dwd/Dsd: Subarctische of boreale klimaat met strenge winters' 
...
, ClassificationValueTopicName 
, CreatorId, ModifierId, CreatedDate, ModifiedDate)  
VALUES(32, 39, 'Gelisol','Gelisol – permafrost soils with permafrost within two metres of the surface or gelic materials and permafrost within one metre.','Gelisol','Gelisol','Gelisol – permafrost soils with permafrost within two metres of the surface or gelic materials and permafrost within one metre.' 
...
, ClassificationValueTopicName 
, CreatorId, ModifierId, CreatedDate, ModifiedDate)  
VALUES(33, 39, 'Histosol','Histosol – organic soils, formerly called bog soils.','Histosol','Histosol','Histosol – organic soils, formerly called bog soils.' 
...
, ClassificationValueTopicName 
, CreatorId, ModifierId, CreatedDate, ModifiedDate)  
VALUES(34, 39, 'Inceptisol','Inceptisol – young soils. They have subsurface horizon formation but show little eluviation and illuviation.','Inceptisol','Inceptisol','Inceptisol – young soils. They have subsurface horizon formation but show little eluviation and illuviation.' 
...
, ClassificationValueTopicName 
, CreatorId, ModifierId, CreatedDate, ModifiedDate)  
VALUES(35, 39, 'Mollisol','Mollisol – soft, deep, dark fertile soil formed in grasslands and some hardwood forests with very thick A horizons.','Mollisol','Mollisol','Mollisol – soft, deep, dark fertile soil formed in grasslands and some hardwood forests with very thick A horizons.' 
