CREATE PROCEDURE HomeIndexAdminGetNoOfRecordsAndPerLanguage (@TableName varchar(30))
AS
IF @TableName = 'Classifications'  
BEGIN
	SELECT 'Classifications' TableDescription
, LanguageName, NoOfRecords FROM (
	SELECT 
		LanguageName
...
BEGIN
	SELECT 'Classification levels' TableDescription
, LanguageName, NoOfRecords FROM (
	SELECT 
		LanguageName
...
BEGIN
	SELECT 'Classification values' TableDescription, 
LanguageName, NoOfRecords FROM (
	SELECT 
		LanguageName
...
BEGIN
	SELECT 'Classification pages' TableDescription, 
LanguageName, NoOfRecords FROM (
	SELECT 
		LanguageName
...
BEGIN
	SELECT 'Classification page sections' TableDescription, 
LanguageName, NoOfRecords FROM (
	SELECT 
		LanguageName
...
BEGIN
	SELECT 'Content types' TableDescription, 
LanguageName, NoOfRecords FROM (
	SELECT 
		LanguageName
...
BEGIN
	SELECT 'left menus' TableDescription, 
LanguageName, NoOfRecords FROM (
	SELECT 
		LanguageName
...
BEGIN
	SELECT 'Menu level 1' TableDescription, 
LanguageName, NoOfRecords FROM (
	SELECT 
		LanguageName
...
BEGIN
	SELECT 'Menu level 2' TableDescription, 
LanguageName, NoOfRecords FROM (
	SELECT 
		LanguageName
...
BEGIN
	SELECT 'Menu level 3' TableDescription, 
LanguageName, NoOfRecords FROM (
	SELECT 
		LanguageName
...
BEGIN
	SELECT 'Organizations' TableDescription, 
LanguageName, NoOfRecords FROM (
	SELECT 
		LanguageName
...
ELSE IF @TableName = 'Organization types'  
BEGIN
	SELECT 'Organization types' TableDescription, 
LanguageName, NoOfRecords FROM (
	SELECT 
		LanguageName
...
BEGIN
	SELECT 'Page sections' TableDescription, 
LanguageName, NoOfRecords FROM (
	SELECT 
		LanguageName
...
BEGIN
	SELECT 'Page section types' TableDescription, 
LanguageName, NoOfRecords FROM (
	SELECT 
		LanguageName
...
BEGIN
	SELECT 'Page types' TableDescription, 
LanguageName, NoOfRecords FROM (
	SELECT 
		LanguageName
...
BEGIN
	SELECT 'Process templates' TableDescription, 
LanguageName, NoOfRecords FROM (
	SELECT 
		LanguageName
...
BEGIN
	SELECT 'Process template fields' TableDescription, 
LanguageName, NoOfRecords FROM (
	SELECT 
		LanguageName
...
BEGIN
	SELECT 'Process template field types' TableDescription, 
LanguageName, NoOfRecords FROM (
	SELECT 
		LanguageName
...
BEGIN
	SELECT 'Process template flows' TableDescription, 
LanguageName, NoOfRecords FROM (
	SELECT 
		LanguageName
...
BEGIN
	SELECT 'Process template flow conditions' TableDescription, 
LanguageName, NoOfRecords FROM (
	SELECT 
		LanguageName
...
ELSE IF @TableName = 'Process template groups'  
BEGIN
	SELECT 'Process template groups' TableDescription, 
LanguageName, NoOfRecords FROM (
	SELECT 
		LanguageName
...
BEGIN
	SELECT 'Process template steps' TableDescription, 
LanguageName, NoOfRecords FROM (
	SELECT 
		LanguageName
...
BEGIN
	SELECT 'Process template step types' TableDescription, 
LanguageName, NoOfRecords FROM (
	SELECT 
		LanguageName
...
BEGIN
	SELECT 'Projects' TableDescription, 
LanguageName, NoOfRecords FROM (
	SELECT 
		LanguageName
...
BEGIN
	SELECT 'User interface terms' TableDescription, 
LanguageName, NoOfRecords FROM (
	SELECT 
		LanguageName
...
BEGIN
	SELECT 'User role types in organizations' TableDescription, 
LanguageName, NoOfRecords FROM (
	SELECT 
		LanguageName
...
BEGIN
	SELECT 'User role types in projects' TableDescription, 
LanguageName, NoOfRecords FROM (
	SELECT 
		LanguageName
...
BEGIN
	SELECT 'User relation types with other users' TableDescription, 
LanguageName, NoOfRecords FROM (
	SELECT 
		LanguageName
